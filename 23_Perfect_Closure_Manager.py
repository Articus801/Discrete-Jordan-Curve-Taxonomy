...
def build_curve_matrix(curve_type="hybrid", depth=4, smooth=False, sigma=4.0):
    """
    Generates target boundaries and applies a strict vertex-welding closure condition
    to guarantee absolute zero-tolerance closure of the Jordan manifold.
    """
    # 1. Define baseline smooth sides of the box
    ...
    if curve_type == "hybrid":
        ...
        # TOPOLOGICAL WELD: Forceptually bind the very last index to the very first index
        # This completely erases floating-point micro-gaps
    ...
    # Strict Zero-Tolerance Jordan Closure Test
    start_pt, end_pt = curve[0], curve[-1]
    is_closed = np.allclose(start_pt, end_pt, atol=1e-8)
...
def automate_pipeline(curve_id, curve_type, depth, smooth, sigma):
    ...
    img_name = f"23_output_job_{curve_id}.png"
...
if __name__ == "__main__":
    print("========================================================")
    print("     RUNNING ROBUST TOPOLOGICAL FACTORY CORE [VER 23]    ")
    print("========================================================")
