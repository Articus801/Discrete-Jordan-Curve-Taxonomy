...
import sys
sys.set_int_max_str_digits(20000)  # Increases the limit to 20,000 digits


def chain_test(ops=5000, p=7, q=19): #1000 to 2000 3000 p q 2,3 2, 5  2,19
    a = PVA(p, 1)  # phi_2^1
    b = PVA(q, 1)  # phi_3^1
