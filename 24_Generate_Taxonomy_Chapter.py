...
latex_content = r"""% --- TOPOLOGICAL TAXONOMY CHAPTER ADDENDUM ---
...
if __name__ == "__main__":
    output_filename = "24_Taxonomy_Chapter.tex"

    with open(output_filename, "w") as latex_file:
        latex_file.write(latex_content)

    print("[24_Generate_Taxonomy_Chapter] Production Success.")
    print(f" -> Generated LaTeX source module saved as '{output_filename}'.")
    print(" This file is fully ready to be included directly in your primary monograph document.")
